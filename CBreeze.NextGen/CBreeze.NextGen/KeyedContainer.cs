...
{
	public abstract class KeyedContainer<TKey, TValue> : Node, IEnumerable<TValue> where TValue : Node, IKeyedValue<TKey>, IEquatable<TValue>
	{
		private Dictionary<TKey, TValue> innerDictionary = new Dictionary<TKey, TValue>();

		internal KeyedContainer(Node parentNode)
		{
