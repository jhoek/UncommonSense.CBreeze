...
namespace UncommonSense.CBreeze.Core
{
    ...
    public class TableRelationConditions : IEnumerable<TableRelationCondition>
    {
        ...
        public TableRelationCondition Add(String fieldName, SimpleTableFilterType type, String value)
        {
        ...
        public TableRelationCondition Insert(int index, String fieldName, SimpleTableFilterType type, String value)
        {
            TableRelationCondition item = new TableRelationCondition(fieldName, type, value);
