...
{
        public class RecordIDTableFieldProperties : Property.Properties
    {
#if NAV2015
        ...
        internal RecordIDTableFieldProperties(RecordIDTableField field)
        {
            Field = field;
        ...
        public RecordIDTableField Field { get; protected set; }
