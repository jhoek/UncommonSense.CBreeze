...
{
        public class DateTableFieldProperties : Property.Properties
    {
#if NAV2015
        ...
        internal DateTableFieldProperties(DateTableField field)
        {
            Field = field;
        ...
        public DateTableField Field { get; protected set; }
