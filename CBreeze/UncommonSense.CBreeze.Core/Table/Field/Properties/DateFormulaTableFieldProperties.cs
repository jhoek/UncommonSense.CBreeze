...
{
        public class DateFormulaTableFieldProperties : Property.Properties
    {
#if NAV2015
        ...
        internal DateFormulaTableFieldProperties(DateFormulaTableField field)
        {
            Field = field;
        ...
        public DateFormulaTableField Field { get; protected set; }
