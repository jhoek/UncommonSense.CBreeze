...
{
    public class BooleanTableFieldProperties : Property.Properties
    {
#if NAV2015
        ...
        internal BooleanTableFieldProperties(BooleanTableField field)
        {
        ...
        public BooleanTableField Field { get; protected set; }
